...
## Our Countmeasures
   Our countmeasures include a novel class in SingletonPlus.java and a routine in SafeNewDemo.java. We will release the SingletonPlus.java in couple of days.
